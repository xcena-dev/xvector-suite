...
function initSearch() {
  ...
  request.open('GET', '/xvector-suite/xvector/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/xvector-suite/xvector/assets/css/just-the-docs-' + theme + '.css');
}
