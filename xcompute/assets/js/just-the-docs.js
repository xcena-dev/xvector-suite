...
function initSearch() {
  ...
  request.open('GET', '/xvector-suite/xcompute/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/xvector-suite/xcompute/assets/css/just-the-docs-' + theme + '.css');
}
