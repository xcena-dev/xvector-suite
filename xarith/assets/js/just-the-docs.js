...
function initSearch() {
  ...
  request.open('GET', '/xvector-suite/xarith/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/xvector-suite/xarith/assets/css/just-the-docs-' + theme + '.css');
}
